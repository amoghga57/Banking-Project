...
<link rel="stylesheet" href="indexError.css">
<title>Log In</title>
</head>
<body>
	<div class="heading">
    ...
    <!-- ----------------------------------------- -->
        <div class="position" id="password">
            ...
            <input class="text" type="password" name="pin"  placeholder="Enter 4 digit password" autocomplete="off" required maxlength="4">
        </div>
    <!-- ----------------------------------------- -->

    <!-- ----------------------------------------- -->
        <div class="sign" >
            <div>New User ? <a href="createAccount.html">Sign in</a></div>
        </div>
    <!-- ----------------------------------------- -->
    	<div class="resError">
